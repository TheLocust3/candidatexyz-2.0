...
Content.create(content_type: 'text', identifier: 'slideshowPanelBlurb', content: { text: 'Seth Moulton is working to put people over politics, ensure that every American has the opportunity to succeed, and tackle the towering challenges of today and tomorrow.' })
Content.create(content_type: 'link', identifier: 'slideshowPanelLink', content: { text: 'Meet Me.', url: '/about' })
